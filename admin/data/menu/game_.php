...
socket.on("admin", function(data)
{
    var game = data;
       ...
       $("#xuc_xac_1").html('<img onclick="taixiu(\'x1\')" src="img/taixiu/'+data.x1+'.png">');
       $("#xuc_xac_2").html('<img onclick="taixiu(\'x2\')" src="img/taixiu/'+data.x2+'.png">');
       $("#xuc_xac_3").html('<img onclick="taixiu(\'x3\')" src="img/taixiu/'+data.x3+'.png">');
       
       $("#b1").html('<img onclick="baucua(\'b1\')" src="img/baucua/'+data.b1+'.png">');
       $("#b2").html('<img onclick="baucua(\'b2\')" src="img/baucua/'+data.b2+'.png">');
       $("#b3").html('<img onclick="baucua(\'b3\')" src="img/baucua/'+data.b3+'.png">');
